...
class MilestonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create milestone" do
    assert_difference("Milestone.count") do
      post milestones_url, params: { milestone: { done: @milestone.done, project_id: @milestone.project_id, title: @milestone.title } }
    end
  ...
  test "should update milestone" do
    patch milestone_url(@milestone), params: { milestone: { done: @milestone.done, project_id: @milestone.project_id, title: @milestone.title } }
