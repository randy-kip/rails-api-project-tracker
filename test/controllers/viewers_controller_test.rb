...
class ViewersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create viewer" do
    assert_difference("Viewer.count") do
      post viewers_url, params: { viewer: { name: @viewer.name, project_id: @viewer.project_id } }
    end
  ...
  test "should update viewer" do
    patch viewer_url(@viewer), params: { viewer: { name: @viewer.name, project_id: @viewer.project_id } }
